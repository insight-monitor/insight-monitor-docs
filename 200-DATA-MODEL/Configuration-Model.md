...
Applied by administrators: minimum required signals during working hours, mandatory redaction rules, allowed configuration range for employees. Stored server-side or in a policy file.
