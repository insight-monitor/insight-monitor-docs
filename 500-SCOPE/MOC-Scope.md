...
> **Terminology Note**: The June 15-29 sprint delivers **Inference Pipeline v0.1** (technical inference engine). The full Product MVP adds challengeability, transparency, and individual benefit features. See [[Inference-Pipeline-v0.1-vs-MVP]].
