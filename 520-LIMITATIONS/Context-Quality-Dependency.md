...
## Problem
Inference accuracy depends heavily on the quality and completeness of the user-provided context. If the user defines vague or incorrect context, the model's classifications will be unreliable.
...
## Implication
The system is only as good as the context it receives. This is not a model limitation — it is a data quality limitation. The system should detect stale or missing context and warn the user.