...
Custom instructions are filtered by the safety layer before injection.
Any instruction attempting to override system constraints is silently ignored
and logged as an attempted override for audit.